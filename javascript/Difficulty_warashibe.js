...
//ローカルデータの取得よう
    function localget(){
        ...
        //船渡し各問題クリアフラグ取得
        clear_1=window.localStorage.getItem("warashibe_1");
...
function tutorialhantei(){
    ...
    document.getElementById('autovideo').innerHTML="<video style='width:40vw;height:60vh;' src='../movie/warashibe_movie.mp4'  id='vid' controls autoplay>";
    modal();
    warashibe_tutorial = "true";
    }else{
        document.getElementById('autovideo').innerHTML="<video style='width:40vw;height:60vh;' src='../movie/warashibe_movie.mp4'  id='vid' controls>";
    }
}
/*画像表示部分*/ 
