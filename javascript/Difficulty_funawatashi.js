...
function tutorialhantei(){
    ...
    document.getElementById('autovideo').innerHTML="<video style='width:40vw;height:60vh;' src='../movie/funawatashi_movie.mp4'  id='vid' controls autoplay>";
    modal();
    funawatashi_tutorial = "true";
    }else{
        document.getElementById('autovideo').innerHTML="<video style='width:40vw;height:60vh;' src='../movie/funawatashi_movie.mp4'  id='vid' controls>";
    }
}
/*画像表示部分*/ 
